              ...
              <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-200 h-full flex flex-col">
                ...
                <div className="p-6 flex flex-col flex-grow">
                  ...
                  <p className="text-sm text-gray-500 mb-4 flex items-center mt-2">
                    ...
                    <span className="font-semibold text-gray-700 mr-2 text-xs">{featuredPost.date} </span>
                  ...
                  <a
                    ...
                    className="text-green-600 font-semibold hover:text-green-700 transition border-green-200 hover:border-green-600 pb-0.5 mt-auto"
                  >
            ...
            {mediumPosts.map((post) => (
              ...
              >
                ...
                <div className="flex-grow">
                  <a
                    href={`/blog/${post.id}`}
                    className="text-base font-semibold text-gray-800 hover:text-green-600 transition line-clamp-2 leading-snug"
                  >
                    {post.title}
                  </a>
